...
echo
echo "🔐 Сейчас будет запрошен пароль для администратора LinOTP ($ADMIN_USER)."
echo "Пожалуйста, введите желаемый пароль вручную, когда появится приглашение:"
echo
...
echo
echo "ℹ️  После настройки вы можете проверить работоспособность системы командой:"
echo
echo "  echo \"User-Name=ИмяПользователя,User-Password=TOTP\" | radclient -s 127.0.0.1 auth testing123"
echo
echo "📝 Замените 'ИмяПользователя' и 'TOTP' на имя пользователя и одноразовый пароль из LinOTP."
echo "🧪 Команда использует 127.0.0.1 и shared secret 'testing123', которые заданы для внутреннего тестирования."
